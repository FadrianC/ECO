...
<head>
    ...
    <title color="#829be8">::Noticias::</title>
</head>
<body>
    ...
    <div>
        ...
        <figure class="snip1208">
          ...
          <figcaption>
            <h3>América Latina y el mundo sobre la Acción Climática</h3>
            <p>
